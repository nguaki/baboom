...
//
// WHO           WHEN            WHAT 
//               06-16-15        Copied from owner_reset_password.php
//                               
//
//
//
...
if( Token::check( "MEMBER_RESET_PW_FORM", $token ) )
{
	if( $New_PW1 == $New_PW2 )
	{
	...
	//}				
		...
		{
			echo "Password must be either alphabet or number(Error:Invalid password)";
		}
	}
	else
	{
